...
export const PERMISSIONS: PermissionDefinition[] = [
  ...
  { code: "warung.consignment.manage", name: "Kelola Konsinyasi Warung", domain: "WARUNG", module: "warung.consignment", sensitive: true },
  ...
  { code: "brilink.consignment.manage", name: "Kelola Konsinyasi BRILink", domain: "BRILINK", module: "brilink.consignment", sensitive: true },
  { code: "print.reprint", name: "Cetak Ulang Dokumen", domain: "GLOBAL", module: "print", sensitive: true },
