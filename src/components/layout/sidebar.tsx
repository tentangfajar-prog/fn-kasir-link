...
const navItems = [
  ...
  { href: "/warung/closing", label: "Closing Warung" },
  { href: "/warung/consignment", label: "Konsinyasi Warung" },
  ...
  { href: "/brilink/closing", label: "Closing BRILink" },
  { href: "/brilink/consignment", label: "Konsinyasi BRILink" },
